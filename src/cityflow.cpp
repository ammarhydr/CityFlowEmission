...
PYBIND11_MODULE(cityflow, m) {
    py::class_<CityFlow::Engine>(m, "Engine")
        ...
        .def("get_lane_vehicle_emission", &CityFlow::Engine::getLaneVehicleEmission)
        .def("get_lane_vehicle_delay", &CityFlow::Engine::getLaneVehicleDelay)
        .def("get_lane_vehicles", &CityFlow::Engine::getLaneVehicles)
        .def("get_vehicle_speed", &CityFlow::Engine::getVehicleSpeed)
        .def("get_vehicle_acceleration", &CityFlow::Engine::getVehicleAcceleration)        
        .def("get_vehicle_emission", &CityFlow::Engine::getVehicleEmission)        
